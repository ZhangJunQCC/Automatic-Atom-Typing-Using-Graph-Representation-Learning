...
class TypingConv(nn.Module):
    def __init__(self, num_features, num_atomic_types, features_str):
        super(TypingConv, self).__init__()
        # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
        #  Begin of network structure definition.
        # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
        self.gcnlayers = nn.ModuleList()
        num_hiddens = 16
        self.gcnlayers.append(TAGConv(num_features, num_hiddens,activation = nn.ReLU()))
        self.gcnlayers.append(TAGConv(num_hiddens, num_hiddens, activation = nn.ReLU()))
        self.gcnlayers.append(TAGConv(num_hiddens, num_atomic_types))
...
class TypingNet(nn.Module):
    def __init__(self, num_features, atomic_types, features_str):
        super(TypingNet, self).__init__()
        # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
        #  Begin of network structure definition.
        # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #        
        self.tclayers = {key:TypingConv(num_features, len(atomic_types[key]), features_str) for key in atomic_types}
        # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
        #  End of network structure definition.
        # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
...
def TypingTrain(net, residues, training_ratio, learning_rate, max_epochs, output_freq, save_fn_prefix, atomic_type_str, device):
    ...
    t_end = time.time()
    print(separator)
    print("Final loss: %.4f" % (training_correctness))
